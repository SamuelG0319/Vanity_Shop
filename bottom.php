...
if (isset($_SESSION['cod_user'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_code_to_remove'])) {
        ...
        header("Location: bottom.php?id=" . $productCode);
        $success = true;
...
<head>
    ...
    <!-- Title  -->
    <title>Vanity - Partes de abajo</title>
                    ...
                    <div class="shop_grid_product_area">
                        <div class="row">
                            ...
                            if ($stmt->rowCount() > 0) {
                                ...
                                echo "No hay productos disponibles para la línea 'bottom'.";
                            }
                            ?>
