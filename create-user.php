...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $phone = $_POST['phone'];
    createUser($user, $password, $name, $lastname, $email, $address, $phone);
    echo "<p style='display: flex; justify-content: center; text-aling: center;'>Cliente registrado con exito</p>";
}
function createUser($user, $password, $name, $lastname, $email, $address, $phone)
{
    global $dbconn;
    $sql = "INSERT INTO `user` (`cod_user`, `company_code`, `user`, `password`, `name`, `last_name`, `email`, `address`, `phone`) VALUES (NULL, NULL, '$user', '$password', '$name', '$lastname', '$email', '$address', '$phone');";
