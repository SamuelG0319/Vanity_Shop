...
<body>
    ...
    <!-- ##### Menu Area Start ##### -->
    <div class="container">
        <button class="btn btn-primary container" onclick="createAdmin()">Create Admin</button>
    </div>

    <br>

    <div class="container">
        <button class="btn btn-info container" onclick="readAdmin()">Read Admin</button>
    </div>

    <br>

    <div class="container">
        <button class="btn btn-secondary container" onclick="updateAdmin()">Update Admin</button>
    </div>

    <br>

    <div class="container">
        <button class="btn btn-danger container" onclick="deleteAdmin()">Delete Admin</button>
    </div>
    <!-- ##### Menu Area End ##### -->
    ...
    <script>
        function createAdmin() {
            ...
            window.location.href = 'create-admin.php'; // Reemplaza con la ruta correcta de tu otra página PHP
        }
    </script>
    ...
    <script>
        function readAdmin() {
            // Redireccionar a la página PHP deseada
            window.location.href = 'read-admin.php'; // Reemplaza con la ruta correcta de tu otra página PHP
        }
    </script>
    ...
    <script>
        function updateAdmin() {
            // Redireccionar a la página PHP deseada
            window.location.href = 'update-admin.php'; // Reemplaza con la ruta correcta de tu otra página PHP
        }
    </script>
    ...
    <script>
        function deleteAdmin() {
            // Redireccionar a la página PHP deseada
            window.location.href = 'delete-admin.php'; // Reemplaza con la ruta correcta de tu otra página PHP
        }
    </script>
    <!-- ##### Script Area End ##### -->