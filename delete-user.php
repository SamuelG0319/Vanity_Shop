...
<body>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="page-title text-center">
                        <h2>Delete Clientes/Usuarios</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="text">
                <div class="checkout_details_area mt-50 clearfix">
                    <div class="cart-page-heading mb-30 text-center">
                        <h5>Enter the user code for Delete</h5>
                    </div>
                    <form action="#" method="post">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="userCode">User Code</label>
                                <input type="text" class="form-control" name="userCode" id="userCode" value="" required>
                            </div>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        global $dbconn;
        $sql = "DELETE FROM user WHERE cod_user LIKE $userCode";
        $result = $dbconn->query($sql);
        echo "<div style='display: flex; text-aling: center; justify-content: center; font-size:18px;'>Usuario eliminado con exito</div>";
    }
    ?>
</body>
