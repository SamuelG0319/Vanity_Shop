...
<body>
    ...
    <?php
    global $dbconn;
    // Consultar la base de datos para obtener todos los registros de la tabla
    ...
    if ($result->rowCount() > 0) {
        ...
        echo "<table border='1' style='display: flex; justify-content: center; text-aling: center; aling-items:center; padding: 5px;'>
            <tr style=''>
                ...
                <th style='padding: 5px; text-align: center;'>Retail Price</th>
                <th style='padding: 5px; text-align: center;'>Sales Tax</th>
        ...
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
            echo "<tr style=''>
                ...
                <td style='padding: 5px; text-align: center;'>" . $row["retail_price"] . "</td>
                <td style='padding: 5px; text-align: center;'>" . $row["sales_tax"] . "</td>
                <td style='padding: 5px; text-align: center;'>" . $row["total"] . "</td>
                </tr>";
        }
