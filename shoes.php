                        ...
                        <div class="widget brands mb-50">
                            ...
                            <div class="widget-desc">
                                <ul>
                                    ...
                                    $brandQuery = "SELECT DISTINCT brand FROM products WHERE product_line = 'shoes'";
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="shop_grid_product_area">
                        <div class="row">
                            ...
                            $query = "SELECT * FROM products WHERE product_line = 'shoes'";
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="single-product-wrapper">
                                            ...
                                            <div class="product-img">
                                                <img src="<?php echo $producto->getImage(); ?>"
                                                    alt="<?php echo $producto->getName(); ?>">
                                                <!-- Hover Thumb -->
                                                <img class="hover-img" src="<?php echo $producto->getImage(); ?>"
                                                    alt="<?php echo $producto->getName(); ?>">
                                            </div>
                    ...
                    <nav aria-label="navigation">
                        <ul class="pagination mt-50 mb-70">
                            ...
                            $totalQuery = "SELECT COUNT(*) as total FROM products WHERE product_line = 'shoes'";
