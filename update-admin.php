                    ...
                    <form action="#" method="post">
                        <div class="row">
                            <div class="col-12 mb-3">
                                <label for="street_address">Admin Code</label>
                                <input type="text" class="form-control mb-3" name="admin_code" id="admin_code" value="">
                            </div>
                            ...
                            <div class="container">
                                <input class="btn btn-primary container" name="btnsubmit" id="btnsubmit" type="submit"
                                    value="Update"></input>
                            </div>
                        </div>
                    </form>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE admin SET username='$user', password='$password', name='$name', last_name='$lastname', phone='$phone', email='$email', position='$position' WHERE cod_admin=$adminCode";
